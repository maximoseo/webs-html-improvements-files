...
2. `%USERPROFILE%/.claude/skills/<skill-name>/.env` (skill-specific)
3. `%USERPROFILE%/.claude/skills/.env` (shared skills)
4. `%USERPROFILE%/.claude/.env` (global)
5. `%USERPROFILE%/.claude/skills/${SKILL}/.env` (cwd)
6. `%USERPROFILE%/.claude/skills/.env` (cwd)
7. `%USERPROFILE%/.claude/.env` (cwd)
...
load_dotenv('%USERPROFILE%/.claude/.env')
load_dotenv('%USERPROFILE%/.claude/skills/.env')
load_dotenv('%USERPROFILE%/.claude/skills/my-skill/.env')
load_dotenv('%USERPROFILE%/.claude/skills/my-skill/.env')
load_dotenv('%USERPROFILE%/.claude/skills/.env')
load_dotenv('%USERPROFILE%/.claude/.env')
