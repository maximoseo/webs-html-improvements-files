...
python3 %USERPROFILE%/.claude/skills/ui-ux-pro-max/scripts/search.py "<style-keywords>" --domain style
python3 %USERPROFILE%/.claude/skills/ui-ux-pro-max/scripts/search.py "<mood>" --domain typography
python3 %USERPROFILE%/.claude/skills/ui-ux-pro-max/scripts/search.py "<industry>" --domain color
```
