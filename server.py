...
def improve_prompt_with_model(payload):
    ...
    system = (
        ...
        'RULE 1 — FULL CONTENT + IMAGES: Every newly generated redesign HTML template MUST include the '
        ...
        'RULE 2 — CORRECT FILE EXTENSIONS: Every output file must be saved and uploaded with its real, '
        ...
        'RULE 3 — MAX 3 FILES PER AGENT FOLDER: Each agent version folder in the GitHub repo '
